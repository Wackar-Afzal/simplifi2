    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="bg-gradient-to-r   text-black py-16">
        <div className="max-w-4xl mx-auto px-6">
          ...
          <p className="text-gray-500 text-lg">Last updated: July 05, 2021</p>
        </div>
      </div>
        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <ul className="list-none space-y-3 mb-6">
              <li className="flex">
                <span className="font-semibold text-blue-600 mr-3">Affiliate</span>
              ...
              <li className="flex">
                <span className="font-semibold text-blue-600 mr-3">Country</span>
                <span className="text-gray-700">refers to: United Arab Emirates</span>
              </li>
              <li className="flex">
                <span className="font-semibold text-blue-600 mr-3">Company</span>
                <span className="text-gray-700">(referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to MENA Card Systems Limited, Unit 208, Level 1, Gate Avenue – South Zone, Dubai, UAE.</span>
              </li>
              <li className="flex">
                <span className="font-semibold text-blue-600 mr-3">Device</span>
              ...
              <li className="flex">
                <span className="font-semibold text-blue-600 mr-3">Service</span>
                <span className="text-gray-700">refers to the Website.</span>
              </li>
              <li className="flex">
                <span className="font-semibold text-blue-600 mr-3">Terms and Conditions</span>
              ...
              <li className="flex">
                <span className="font-semibold text-blue-600 mr-3">Third-party Social Media Service</span>
              ...
              <li className="flex">
                <span className="font-semibold text-blue-600 mr-3">Website</span>
                <span className="text-gray-700">refers to SimpliFi, accessible from simplifipay.com</span>
              </li>
              <li className="flex">
                <span className="font-semibold text-blue-600 mr-3">You</span>
          ...
          <section className="mb-8">
            ...
            <div className="space-y-4 text-gray-700">
              ...
              <p>
                Some countries do not allow the exclusion of implied warranties or limitation of liability for incidental or consequential damages, which means that some of the above limitations may not apply. 
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700">
              <strong>By email:</strong> <a href="mailto:admin@simplifipay.com" className="text-blue-600 hover:text-blue-800 underline">admin@simplifipay.com</a>
            </p>
          </section>
        </div>
      </div>
