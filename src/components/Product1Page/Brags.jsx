  ...
  return (
    <section className="relative w-full slider-section   overflow-hidden p-5 py-20">
      <div className="flex items-center justify-between mb-10">
        <h1 className="h2">Humblebrags</h1>
      ...
      <Splide
        ...
        options={{
          ...
          autoplay: false,
          interval: 4000,
          gap: "1rem", // can also try "16px" for precise control
          arrows: false,
          pagination: true,
          perPage: 5, // 5 slides fully visible
          perMove: 1,
          focus: 0, // no centering
          padding: 0, // remove extra padding
          pauseOnHover: false,
            breakpoints: {
                        1280: { perPage: 4 }, // large tablets
                        1024: { perPage: 3 }, // tablets
                        768: { perPage: 2 },  // small tablets / large phones
                        480: { perPage: 2 },  // mobile
                    },
        }}
      >
        {slides.map((slide, index) => (
          <SplideSlide key={index} className="relative feed-link">
            <div class="brags-card">
              ...
              <img
                src="https://cdn.prod.website-files.com/678e5f1a1f6220b154b30471/679360fd5046b0720ca30d37_Button%20container.svg"
                loading="lazy"
                alt=""
              />
            </div>
